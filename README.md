...
To help the training of GPT to learn POWER-KI programming in the directory <a href="https://github.com/POWER-KI/POWER-KI/tree/master/AI-Docs"AI-DOCs</a> text documents
that explain POWER-KI rules and programming coding sintax. 
...
* New WRAP: PYT - <b>execute from PWK->PYTHON code and from PyTHON->PWK code</b>;</br>
